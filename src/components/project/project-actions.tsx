...
/**
 * Par de ações no pé do card: "Ver projeto" (aprofundar) e "Quero um projeto
 * assim" (conversar). Mesma escala tipográfica; a hierarquia vem do contraste —
 * taupe para explorar, tinta preta + fio para o contato, que é o fim de linha
 * da coluna. Sem verde: o WhatsApp entra como glifo, não como marca.
 */
export function ProjectActions({
  ...
  return (
    // Empilhado por padrão; vira linha única só no lg. Abaixo disso a coluna de
    // texto (48% do card) é estreita demais e os dois rótulos quebram no meio.
    ...
    <div className="reveal-illuminate flex flex-col gap-1 md:items-start lg:flex-row lg:items-center lg:gap-6">
      <Link
