  ...
  return (
    <div className="px-8 py-12 md:px-16 lg:px-24">
      <div className="mx-auto max-w-[1200px]">
        ...
        {/* Quick stats */}
        <div className="mt-16 grid grid-cols-1 gap-px md:grid-cols-3" style={{ background: "hsl(var(--accent) / 0.3)" }}>
        ...
        {/* Quick links */}
        <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
          <QuickLink
            href="/admin/projetos"
...
function QuickLink({
  ...
  return (
    <Link
      href={href}
      className="group block border p-8 transition-colors hover:bg-secondary/30"
